...
@NgModule({
  declarations: [DashboardComponent, DashHeaderComponent, DashFooterComponent, HomeDashComponent, AddMonumentComponent, MonumentsListeAdminComponent, AddConstatComponent, AddEventTravailComponent, ConstatsListeAdminComponent],
  exports: [
   DashboardComponent
  ],
  imports: [
